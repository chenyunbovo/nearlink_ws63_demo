...
struct blufi_recv_softap_param{
    uint8_t *ssid;
    int ssid_len;
    uint8_t *passwd;
    int passwd_len;
...
typedef struct {
    uint8_t wifi_mode;
    struct blufi_recv_sta_param sta;
    struct blufi_recv_softap_param softap;
    struct blufi_recv_ca_param ca;
    uint8_t *custom_data;
    int custom_data_len;
}blufi_cb_param_t;
